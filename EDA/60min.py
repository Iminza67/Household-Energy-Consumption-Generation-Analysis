...
# Path to your 60-min dataset (relative to project root)
input_file = "data\\household_data_60min_singleindex.csv"
...
# Folder to save 60-min household data in root-level data folder
output_folder = os.path.join(project_root, "data", "60min")
...
for h in households:
    ...
    output_file = os.path.join(output_folder, f"{h}_60min.csv")

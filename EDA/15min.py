...
# Path to your 15-min dataset (relative to project root)
input_file = "../data/household_data_15min_singleindex.csv"
...
# Folder to save 15-min household data in root-level data folder
output_folder = os.path.join(project_root, "data", "15min")
...
for h in households:
    ...
    output_file = os.path.join(output_folder, f"{h}_15min.csv")
